...
export function PostCard({ post, showTaxonomy = true }: PostCardProps) {
  return (
    <article className="group flex flex-col overflow-hidden rounded-lg border bg-card p-5 transition-shadow hover:shadow-lg">
      ...
      <Link
        href={`/blog/${post.slug}`}
        className="mt-auto flex items-center justify-between text-sm text-muted-foreground"
      >
