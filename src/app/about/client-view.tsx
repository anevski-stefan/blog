...
export function AboutClientView() {
  ...
  return (
    <div ref={containerRef} className="text-white font-body min-h-screen">
      <SiteHeader />
        ...
        <header className="mb-32 md:mb-48 relative">
          ...
          <div className="reveal-text max-w-2xl text-lg md:text-xl text-home-muted leading-relaxed space-y-6">
            <p>
              ...
              user experience. Code is my medium, and the browser is my canvas.
            </p>
            <p>
          ...
          <div className="flex flex-col md:flex-row gap-16 md:gap-24 items-start">
            <div className="md:sticky md:top-32 md:w-1/3 space-y-8">
              <div>
                ...
                <p className="text-home-muted text-sm leading-relaxed">
                  My toolkit is curated for high-performance, scalable modern
                  web development. Each technology is selected for its
            ...
            <div className="md:w-2/3 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {skills.map(skill => (
                ...
                >
                  <div className="absolute inset-0 bg-white/5 border border-white/10 rounded-xl transition-all duration-300 group-hover:bg-white/10 group-hover:border-home-accent/50 group-hover:shadow-[0_0_30px_-5px_var(--home-accent)] shadow-none"></div>
